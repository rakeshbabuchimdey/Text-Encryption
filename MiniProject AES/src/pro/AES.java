...
{ 
	...
	private static int[] sbox = {  };
 ...
 0x5e, 0xbc, 0x63, 0xc6, 0x97, 0x35, 0x6a, 0xd4, 0xb3, 0x7d, 0xfa, 0xef, 0xc5, 0x91, 0x39, 0x72, 0xe4, 0xd3, 0xbd, 0x61, 0xc2, 0x9f, 0x25, 0x4a, 0x94, 0x33, 0x66, 0xcc, 0x83, 0x1d, 0x3a, 0x74, 0xe8, 0xcb }; 
	...
	} private static byte[][] generateSubkeys(byte[] key) 
	{
		 ...
		 while (i < Nk) 
		 {
		 	 tmp[i][0] = key[i * 4]; tmp[i][1] = key[i * 4 + 1];
		 	 tmp[i][2] = key[i * 4 + 2]; 
		 	 tmp[i][3] = key[i * 4 + 3]; i++;
		 } 
		 i = Nk;
		 	...
		 	if (i % Nk == 0)
		        { 
		        	...
		        	temp[0] = (byte) (temp[0] ^ (Rcon[i / Nk] & 0xff)); 
                        ...
                        tmp[i] = xor_func(tmp[i - Nk], temp); i++;
                 } return tmp;
        }
